					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-8 col-lg-9 main">
								...
								<!-- GOOGLE MAP -->
								<div class="section">
									<div id="contact-map" class="google-map" data-lat="-12.0723158" data-lng="-76.9419007" data-mlat="-12.0723158" data-mlng="-76.9419007"></div>
								</div>
								<!-- /GOOGLE MAP -->
								<div class="col-xs-12 col-sm-8 col-lg-8 main">
								<div class="row">
								<!-- CONTACT FORM -->
								<div class="section contact-inner">
									<h4 class="section-title">Informacion de cliente</h4>
									<div class="section-inner">
										
										<p>Ingresa los datos necesarios para poder comunicarnos  y completar el proceso de compra online. </p>
										<div class="space20"></div>
										
										<form:form method="post"  action="enviarAdquisicion.htm" commandName="mensaje">
										
											<spring:message code="label.nombreC"/>:				
												<form:input path="nombre"/>
												<font color="red"><form:errors path="nombre"/></font>
												<br>
												<spring:message code="label.emailC"/>:
												<form:input path="email" />
												<font color="red">  <form:errors path="email"/></font>
											    <br>
										        <spring:message code="label.tituloC"/>:
												<form:input path="tituto"  />
										        <font color="red">  <form:errors path="tituto"/></font>
												<br>
											    <spring:message code="label.mensajeC"/>: <br>
												<form:textarea rows="4" cols="50"  path="mensaje"></form:textarea>
											    <br>
											    <input style="margin-top:40px" type="submit" value="Enviar" class="btn btn-primary">
										...
										<div class="alert alert-success" id="contact_success" style="display: none;">
											...
											<div class="alert-inner">
												<strong>Gracias,</strong> su mensaje a sido enviado y se le respondera a la brevedad posible...
											</div>
										</div>
										<!-- /success msg -->
